...
class TypescriptOpenPluginDefaultSettingFile(sublime_plugin.WindowCommand):
    def run(self):
        default_plugin_setting_path = os.path.join(PLUGIN_DIR, "LangserverConnector.sublime-settings")
...
class TypescriptOpenTsDefaultSettingFile(sublime_plugin.WindowCommand):
    def run(self):
        default_ts_setting_path = os.path.join(PLUGIN_DIR, "LangserverConnector.sublime-settings")
